...
For more information about aspect, see the documentation:
...
def _file_collector_aspect_imp(target, ctx):
...
file_collector_aspect = aspect(
    implementation = _file_collector_aspect_imp,
    attr_aspects = ["deps"],
    attrs = {
